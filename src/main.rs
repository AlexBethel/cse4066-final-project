...
// use crate::cnn::{LeakyRelu, Linear, Logistic};
...
//     let mut layer =
//         FullyConnectedLayer::new(1, 1, Linear).stack(FullyConnectedLayer::new(1, 1, Linear));
//     dbg!(&layer);
...
//         // }) / 10.0
//     };
//     for input in xes.iter().cloned().map(|x| x * 1.0).cycle().take(1000) {
